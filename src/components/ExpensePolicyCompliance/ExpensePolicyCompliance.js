...
class ExpensePolicyCompliance extends Component {
  render(){
  return (
    ...
    <FormLabel className ='left' style={{ 'text-align':'left','margin-top': '23px'}}>
                <h2 style={{ color: '#c0548e'}}>Expense Policy Compliance </h2>
      </FormLabel>
     </FormControl> 
     ...
     <Grid container spacing={1}>
            ...
            <FormLabel style={{ 'text-align':'left',color: '#c0548e','margin-left':'10px' }}>
